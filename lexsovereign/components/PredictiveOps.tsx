                 ...
                 <div key={risk.id} className="bg-slate-900 border border-slate-800 p-6 rounded-3xl space-y-4 hover:border-amber-500/30 transition-all group cursor-pointer">
                    <div className="flex items-center justify-between">
                       ...
                       <span className={`px-2 py-0.5 rounded text-[9px] font-bold uppercase border ${
                         risk.impact === 'High' ? 'bg-red-500/10 text-red-400 border-red-500/20' : 'bg-amber-500/10 text-amber-400 border-amber-500/20'
                       }`}>
                          {risk.impact} Impact
                       </span>
                    </div>
              ...
              <div className="space-y-6">
                 ...
                 <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                       {billing.map(entry => (
                         <div key={entry.id} className={`p-4 rounded-2xl border transition-all ${
                           entry.status === 'CLEAN' ? 'bg-slate-950/50 border-slate-800' : 'bg-red-500/5 border-red-500/20'
                         }`}>
