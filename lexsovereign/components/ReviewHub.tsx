              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <span className={`text-[9px] font-bold px-2 py-0.5 rounded border uppercase ${
                    artifact.urgency === 'Critical' ? 'bg-red-500/10 text-red-400 border-red-500/20' :
                  ...
                  <div className="flex items-center gap-1.5">
                    <div className={`w-1.5 h-1.5 rounded-full ${
                      artifact.status === ReviewStatus.APPROVED ? 'bg-emerald-500' : 'bg-blue-500 animate-pulse'
                    }`}></div>
          ...
          {selectedArtifact ? (
            <div className="bg-slate-900 border border-slate-800 rounded-[2.5rem] p-8 space-y-8 shadow-2xl relative overflow-hidden animate-in zoom-in-95 duration-300">
               ...
               <div className="pt-6 border-t border-slate-800/50 flex gap-4">
                  ...
                  <button className="px-6 bg-slate-800 hover:bg-red-500/10 text-slate-400 hover:text-red-400 border border-slate-700 rounded-2xl transition-all">
                    <ShieldAlert size={20} />
                  </button>
               </div>
            </div>
