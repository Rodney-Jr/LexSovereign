    ...
    <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in slide-in-from-right-8 duration-700 pb-20">
      <div className="text-center space-y-4 pt-8">
        ...
        <div className="space-y-1">
          ...
          <p className="text-slate-400 text-sm">Welcome back, Accra Partners Ltd. Your data is currently pinned to GH-ACC-1.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-slate-900 border border-slate-800 p-8 rounded-[2.5rem] space-y-8 shadow-2xl relative overflow-hidden group">
           ...
           <div className="space-y-6">
              <div>
                 <p className="text-lg font-bold text-white tracking-tight">MT-772: Shareholder Restructuring</p>
                 <p className="text-[10px] text-slate-500 font-mono">MATTER-ID: GH-ACC-LIT-9922</p>
              </div>
           ...
           <div className="space-y-6">
              ...
              <div className="bg-emerald-500/5 border border-emerald-500/10 p-4 rounded-2xl space-y-2">
                 ...
                 <p className="text-[10px] text-slate-400 leading-relaxed italic">
                   "Your data has not moved from the Accra-GH-1 silo. 0 packets detected in transit outside Ghana."
                 </p>
              </div>
