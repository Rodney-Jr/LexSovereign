-- Force add missing columns for updatedAt synchronization
-- This script is designed for Railway's 'prisma migrate deploy' to catch up any missed migrations
-- Using case-insensitive checks for maximum robustness
