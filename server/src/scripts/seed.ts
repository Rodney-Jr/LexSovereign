...
const PERMISSIONS = [
    ...
    { id: 'CREATE:MATTER', description: 'Can create matters', resource: 'MATTER', action: 'CREATE' },
...
const ROLES = [
    ...
    { name: 'TENANT_ADMIN', permissions: ['MANAGE:TENANT_SETTINGS', 'VIEW_STATS:TENANT', 'MANAGE:USER', 'MANAGE:ROLE', 'MANAGE:TENANT_SETTINGS', 'MANAGE:WORKFLOW', 'CREATE:DRAFT', 'UPLOAD:DOCUMENT', 'ACCESS:HR', 'ACCESS:ACCOUNTING', 'ACCESS:ROADMAP', 'ACCESS:INFRASTRUCTURE', 'VIEW:TRIAL', 'CREATE:MATTER'] },
