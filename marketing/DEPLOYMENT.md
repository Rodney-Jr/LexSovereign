...
1.  **Railway Dashboard**:
    ...
    - Select your `Nomosdesk` repository.
...
4.  **Domains**:
    - Railway will provide a default domain (e.g., `Nomosdesk-marketing.up.railway.app`). You can bind your custom marketing domain here.
