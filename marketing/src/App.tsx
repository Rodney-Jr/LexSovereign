...
const App = () => {
    ...
    const SlideNav = ({ activeId }: { activeId: string }) => {
        const sections = [
            { id: 'hero', label: 'Home' },
            { id: 'enclaves', label: 'Network' },
            { id: 'pillars', label: 'Pillars' },
            { id: 'solutions', label: 'Solutions' },
            { id: 'compliance', label: 'Compliance' },
            { id: 'intelligence', label: 'Intelligence' },
            { id: 'workflow', label: 'Mastery' },
            { id: 'governance', label: 'Governance' }
        ];

        return (
            <div className="fixed right-8 top-1/2 -translate-y-1/2 z-[60] hidden lg:flex flex-col gap-4">
                {sections.map(s => (
                    <a
                        key={s.id}
                        href={`#${s.id}`}
                        ...
                        title={s.label}
                    >
                        <span className="absolute right-8 top-1/2 -translate-y-1/2 px-3 py-1 bg-slate-900 border border-white/10 rounded text-[10px] font-bold text-white opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none uppercase tracking-widest">
                            {s.label}
                        </span>
                    </a>
                ))}
    ...
    return (
        <div className="min-h-screen hero-gradient font-inter selection:bg-blue-500/30 overflow-x-hidden">
            <SlideNav activeId={activeSection} />
            ...
            <div className="snap-container">
                ...
                <section id="hero" className="snap-section relative overflow-hidden text-white">
                    <div className="max-w-7xl mx-auto px-6 text-center animate-fade-in">
                        ...
                        <h1 className="text-6xl md:text-[6.5rem] font-black tracking-tighter mb-10 leading-[0.9] font-outfit">
                    ...
                    <ExploreNext targetId="enclaves" label="Network" />
                </section>

                {/* Regional Network Showcase */}
                <section id="enclaves" className="snap-section">
                    ...
                    <ExploreNext targetId="pillars" label="Pillars" />
                </section>

                {/* Value Pillars Section */}
                <section id="pillars" className="snap-section border-y border-white/5 bg-slate-900/10">
                    <div className="max-w-7xl mx-auto px-6 py-24">
                    ...
                    <ExploreNext targetId="solutions" label="Solutions" />
                </section>

                {/* Targeted Solutions */}
                <section id="solutions" className="snap-section">
                    ...
                    <ExploreNext targetId="compliance" label="Compliance" />
                </section>

                {/* Compliance Matrix */}
                <section id="compliance" className="snap-section bg-slate-900/30">
                    <div className="max-w-7xl mx-auto px-6 py-32">
                    ...
                    <ExploreNext targetId="intelligence" label="Intelligence" />
                </section>

                {/* Sovereign Intelligence Layer */}
                <section id="intelligence" className="snap-section bg-slate-950">
                    ...
                    <ExploreNext targetId="workflow" label="Operations" />
                </section>

                {/* Operational Workflow Mastery */}
                <section id="workflow" className="snap-section bg-slate-900/50 border-y border-white/5 relative overflow-hidden">
                    ...
                    <ExploreNext targetId="governance" label="Governance" />
                </section>

                {/* Governance Section */}
                <section id="governance" className="snap-section">
                    <div className="max-w-7xl mx-auto px-6 py-24">
                ...
                {/* Footer */}
                <footer className="border-t border-white/5 py-20 text-white snap-section">
