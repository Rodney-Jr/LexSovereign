            ...
            >
              ...
              <div className="flex-1 space-y-1.5 pt-1">
                ...
                <div className="flex items-center gap-4 pt-3">
                  <div className={`flex items-center gap-2 text-[9px] font-mono font-bold uppercase tracking-tight px-3 py-1 rounded-full border ${activeStep >= idx ? 'bg-slate-950/50 border-slate-800 text-slate-400' : 'bg-transparent border-transparent'
                    }`}>
