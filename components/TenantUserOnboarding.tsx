...
const TenantUserOnboarding: React.FC<TenantUserOnboardingProps> = ({ mode, onComplete }) => {
  const [step, setStep] = useState(1);
  const [inviteToken, setInviteToken] = useState('SOV-INV-992-XXXX');
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-[3.5rem] p-10 shadow-[0_0_80px_rgba(0,0,0,0.5)] backdrop-blur-xl relative overflow-hidden">
             ...
             <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="p-5 bg-blue-500/5 border border-blue-500/10 rounded-3xl flex items-start gap-4">
                   ...
                   <p className="text-[10px] text-slate-400 leading-relaxed italic">
                     This link only resolves when accessed from an authorized <strong className="text-slate-300">Corporate Domain (accrapartners.gh)</strong>.
                   </p>
                </div>
             </div>
           )}
             ...
             <div className="space-y-8 animate-in slide-in-from-right-8 duration-500 text-center">
                ...
                <div className="py-10 flex justify-center">
                   <div 
                    ...
                    className={`w-32 h-32 rounded-[2.5rem] flex items-center justify-center border-4 cursor-pointer transition-all duration-700 relative group ${
                      mfaEnrolled ? 'bg-emerald-500/20 border-emerald-500 text-emerald-400 shadow-[0_0_50px_rgba(16,185,129,0.3)]' :
           ...
           {step === 3 && (
             <div className="space-y-8 animate-in zoom-in-95 duration-500">
                ...
                >
                  Join Sovereign Silo <ArrowRight size={20} />
                </button>
             </div>
           )}
        </div>
