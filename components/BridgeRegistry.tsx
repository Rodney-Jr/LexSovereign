            ...
            >
              <div className="flex items-start justify-between mb-6 relative z-10">
                <div className="flex items-center gap-4">
                  <div className={`p-3 rounded-2xl transition-colors ${selectedId === bridge.id ? 'bg-emerald-500 text-white' : 'bg-slate-800 text-slate-500 group-hover:text-emerald-400'
                    }`}>
